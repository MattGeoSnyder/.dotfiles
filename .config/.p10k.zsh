# Generated by Powerlevel10k configuration wizard on 2024-12-13 at 13:22 EST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49619.
# Wizard options: compatible, rainbow, unicode, 12h time, blurred heads, flat tails,
# 2 lines, dotted, no frame, darkest-ornaments, sparse, fluent, transient_prompt,
